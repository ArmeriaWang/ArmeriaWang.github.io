...
![img](/images/asserts/16eeb62d7be0566d)![img](/images/asserts/315px-Hash_table_3_1_1_0_1_0_0_SP.svg.png)
...
<img src="/images/asserts/706569-20190228162257774-1437530387.png" alt="img" style="zoom:67%;" />

经过`resize`后的，键值对的位置变成`Key`对4取余。这时的`HashMap`如下：

<img src="/images/asserts/image-20200410183126804.png" alt="image-20200410183126804" style="zoom: 50%;" />
...
<img src="/images/asserts/706569-20190228225719031-1717698945.png" alt="img" style="zoom:50%;" />

线程A挂起后，线程B正常执行，并完成`resize`操作，结果如下：

<img src="/images/asserts/706569-20190228172856047-216194328.png" alt="img" style="zoom: 67%;" />
...
<img src="/images/asserts/706569-20190228173450442-1058177260.png" alt="img" style="zoom: 50%;" />

接下来，线程A继续循环。整个`transfer`方法执行完毕后，我们会得到这样的一个哈希表：

<img src="/images/asserts/706569-20190228174116585-716787662.png" alt="img" style="zoom:50%;" />
